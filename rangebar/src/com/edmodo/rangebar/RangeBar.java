...
/**
 * The RangeBar is a double-sided version of a {@link android.widget.SeekBar} with discrete values. Whereas the thumb for the SeekBar can be
...
public class RangeBar extends View {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		mLeftThumb = new Thumb(ctx, yPos, mThumbColorNormal, mThumbColorPressed, mThumbRadiusDP, mThumbImageNormal, mThumbImagePressed);
		mRightThumb = new Thumb(ctx, yPos, mThumbColorNormal, mThumbColorPressed, mThumbRadiusDP, mThumbImageNormal, mThumbImagePressed);
	...
	/**
	 * Sets a listener to receive notifications of changes to the RangeBar. This will overwrite any existing set listeners.
	 *
	 * @param listener
	 * 		the RangeBar notification listener; null to remove any existing listener
	 */
	...
	/**
	 * If this is set, the thumb images will be replaced with a circle. The normal image will be of the specified color.
	 *
	...
	/**
	 * If this is set, the thumb images will be replaced with a circle. The pressed image will be of the specified color.
	 *
	 * @param thumbColorPressed
	 * 		Integer specifying the pressed color of the circle to be drawn.
	 */
	...
	/**
	 * Sets the location of each thumb according to the developer's choice. Numbered from 0 to mTickCount - 1 from the left.
	 *
	...
	/**
	 * Does all the functions of the constructor for RangeBar. Called by both RangeBar constructors in lieu of copying the code for each
	 * constructor.
	 *
	 * @param context
