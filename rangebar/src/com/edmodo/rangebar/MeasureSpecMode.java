...
/**
 * Helper enum class for transforming a measureSpec mode integer value into a human-readable String. The human-readable String is simply the name
 * of the enum value.
 */
public enum MeasureSpecMode {
	 ...
	 *
	 * @param measureSpec
	 * 		the measure specification passed by the platform to {@link View#onMeasure(int, int)}
	 *
